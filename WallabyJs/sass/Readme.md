...
folder are mapped to the application's root namespace, 'WallabyJs'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'WallabyJs' in the same way
as `"WallabyJs/sass/src"`.
